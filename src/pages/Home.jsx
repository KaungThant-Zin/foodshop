    ...
    return (
        <div>
            <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 items-center">
                <Fade left>
                <div className=" mt-5 text-center transform transition duration-1000 ease-in-out">
                    <h1 className="headfont text-4xl lg:text-6xl  foodcolor font-bold">Best foodshop ever</h1>
                    ...
                    <div className="flex justify-center">
                        <Link to="/menu" className="mt-5 mb-0 bg-yellow-500 text-white flex px-4 py-3 rounded-full animate-Fade shadow-xl">
                            ORDER NOW
                ...
                <div className=" lg:my-10 transform transition duration-1000 ease-in-out p-3 flex justify-center">
                    <Flip>
