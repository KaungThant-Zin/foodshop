    ...
    return (
        <div>
            <div className="grid lg:grid-cols-2 md:grid-cols-1 items-center">
                <div className={`${isAnimated ? 'scale-100' : '-translate-x-full'} mt-5 text-center transform transition duration-1000 ease-in-out`}>
                    <h1 className="headfont text-5xl lg:text-6xl  foodcolor font-bold">Best foodshop ever</h1>
                    ...
                    <div className="flex justify-center">
                        <Link to="/menu" className="mt-5 mb-0 bg-yellow-500 text-white flex px-4 py-3 rounded-full animate-bounce shadow-xl">
                            ORDER NOW
                        <svg className="w-6 h-6 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                        </Link>
                    </div>
                </div>
                <div className={`${isAnimated ? 'scale-100' : 'translate-x-full translate-y-full'} lg:my-10 transform transition duration-1000 ease-in-out p-3 flex justify-center `}>
                    <Flip>
